...
| **[`subscription_proxy_zcode`](./skills/subscription_proxy_zcode)** | Proxy local OAuth e hub de assinaturas (Gemini 4 contas, Claude, Codex, OpenCode) com contexto de 1M e CodeNotch no ZCode. | 🟢 Ativo | `npx skills add Kadu1992/subscription_proxy_zcode` |
